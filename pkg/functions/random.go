...
func (f *RandomFunction) Execute(ctx context.Context, args []interface{}) (interface{}, error) {
	if len(args) != 1 {
...
func (f *RandomStringFunction) Execute(ctx context.Context, args []interface{}) (interface{}, error) {
...
func (f *UUIDFunction) Execute(ctx context.Context, args []interface{}) (interface{}, error) {
	if len(args) != 0 {
